...
# Common flags for libjsonsm modules. This defines the specific flags
...
#       many warnings.
#   LJSM_CORE_CXXFLAGS:
#       Like LJSM_CORE_CFLAGS, but for C++
#
#   LJSM_BASIC_CFLAGS
...
LIST(APPEND LJSM_GNUC_CPP_WARNINGS
...
IF(CMAKE_C_COMPILER_ID STREQUAL "Clang")
  LIST(APPEND LJSM_GNUC_CPP_WARNINGS -Wno-cast-align -Wno-dollar-in-identifier-extension)
ENDIF()
...
list2args(LJSM_GNUC_CPP_WARNINGS)
...
LIST(APPEND LJSM_CL_CPPFLAGS /nologo /W3 /MP /EHsc)
LIST(APPEND LJSM_CL_CPPFLAGS /wd4800 /wd4244 /wd4267)
list2args(LJSM_CL_CPPFLAGS)

# Common flags for DEBUG
LIST(APPEND LJSM_CL_CPPFLAGS_DEBUG /RTC1)
list2args( LJSM_CL_CPPFLAGS_DEBUG)

# Common flags for RELEASE
LIST(APPEND LJSM_CL_CPPFLAGS_REL /O2)
list2args(LJSM_CL_CPPFLAGS_REL)
...
IF(MSVC)
  ...
  ENDIF()
  SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /TC ${LJSM_CL_CPPFLAGS}")
  SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${LJSM_CL_CPPFLAGS}")
  SET(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} ${LJSM_CL_CPPFLAGS_DEBUG}")
  SET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} ${LJSM_CL_CPPFLAGS_DEBUG}")
  SET(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} ${LJSM_CL_CPPFLAGS_REL}")
  SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} ${LJSM_CL_CPPFLAGS_REL}")
  ...
  SET(LJSM_CORE_CXXFLAGS "")
  SET(LJSM_CORE_CFLAGS "")
  SET(LJSM_BASIC_CFLAGS "")
  SET(LJSM_BASIC_CXXFLAGS "")
...
ELSE()
  ...
  ENDIF()
  SET(LJSM_CORE_CFLAGS "${LJSM_GNUC_C_WARNINGS} -DHAVE_VISIBILITY -fvisibility=hidden")
  SET(LJSM_CORE_CXXFLAGS "${LJSM_GNUC_CXX_WARNINGS} -DHAVE_VISIBILITY -fvisibility=hidden")
ENDIF()

IF(LJSM_UNIVERSAL_BINARY AND (${CMAKE_SYSTEM_NAME} MATCHES "Darwin"))
  SET(CMAKE_C_FLAGS
